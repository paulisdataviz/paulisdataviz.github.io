...
If you are wondering how I parsed and extracted the data, below is the sample code I used to extract Data Sources information from .twb file using the library xml2, the main steps in this process are:

1.  Identify the parent node: **"//datasource"**

2.  Identify the attributes to extract:

    1.  Extract data source caption: **"caption"**

    2.  Extract data source name: **"name"**

3.  Save results into a data frame

4.  Do some data wrangling / cleaning steps (impute NAs and keep unique values) to be able to make sense of data.

![](images/paste-9330A47F.png)

![](images/paste-86166C88.png)
...
I broke down the App into three main tabs / sections:
